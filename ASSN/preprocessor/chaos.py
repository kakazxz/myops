...
if __name__=="__main__":
    image_dirs = sort_glob('E:\\consistent_workspace\\dataset\\CHOAS\\CHAOS_Train_Sets\\Train_Sets\\CT\\*\\DICOM_anon')
    lab_dirs = sort_glob('E:\\consistent_workspace\\dataset\\CHOAS\\CHAOS_Train_Sets\\Train_Sets\\CT\\*\\Ground')
    generate_3dCT(image_dirs, lab_dirs, 'ct')

    image_dirs = sort_glob('E:\\consistent_workspace\\dataset\\CHOAS\\CHAOS_Train_Sets\\Train_Sets\\MR\\*\\T1DUAL\\DICOM_anon\\InPhase')
    lab_dirs= sort_glob('E:\\consistent_workspace\\dataset\\CHOAS\\CHAOS_Train_Sets\\Train_Sets\\MR\\*\\T1DUAL\\Ground')
    generate_3dMR(image_dirs, lab_dirs, 'mr')
